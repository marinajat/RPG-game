...
public class NPC_Princesa extends Entity {
    ...
    public void getImage() {
        up1 = setup("/npc/princesa_up_1", gp.tileSize,gp.tileSize);
        up2 = setup("/npc/princesa_up_2", gp.tileSize,gp.tileSize);
        down1 = setup("/npc/princesa_down_1", gp.tileSize,gp.tileSize);
        down2 = setup("/npc/princesa_down_2", gp.tileSize,gp.tileSize);
        left1 = setup("/npc/princesa_left_1", gp.tileSize,gp.tileSize);
        left2 = setup("/npc/princesa_left_2", gp.tileSize,gp.tileSize);
        right1 = setup("/npc/princesa_right_1", gp.tileSize,gp.tileSize);
        right2 = setup("/npc/princesa_right_2", gp.tileSize,gp.tileSize);
    }
